...
@NoArgsConstructor
@Entity
@Table(name = "t_complaint_saved", schema = "saveforms")
public class ComplainantSavedFormEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "COMPL_SAVE_SRNO")
    private Long complSaveSrno;

    @Column(name = "COMPL_SAVED_NUM", nullable = false)
    private Long complSavedNum;
    ...
    @Column(name = "IS_COMPL_SUBMTTD", length = 1)
    private String isComplSubmttd;

    @Column(name = "SUBMTTD_COMPL_NUM")
    private Long submttdComplNum;
